    ...
    */
    ...
    public function getGoogleLoginUrl() {
        try {
            ...
            error_log('Google OAuth URL Generation - Client ID: ' . substr(GOOGLE_CLIENT_ID, 0, 20) . '...');
            error_log('Google OAuth URL Generation - Redirect URI: ' . GOOGLE_REDIRECT_URI);
            error_log('Google OAuth URL Generation - State: ' . $state);
            ...
            error_log('Error generating Google OAuth URL: ' . $e->getMessage());
            throw $e;
        }
    }
